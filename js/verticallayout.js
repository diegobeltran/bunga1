...
(function () {
    ...
    var myData = [
    { header: "Templates",  picture: "fa fa-th", color:"tile orange w2 h1 icon-featurecw titlex-fadeout isotope-item" },
     { header: "Composition",  picture: "fa fa-picture-o" , color:"tile blue w2 h1 icon-featurecw titlex-fadeout isotope-item"},
       { header: "Documents",  picture: "fa fa-file" , color:"tile green w2 h1 icon-featurecw titlex-fadeout isotope-item"},
      { header: "about",  picture: "fa fa-bars", color:"tile purple w2 h1 icon-featurecw titlex-fadeout isotope-item" },
       { header: "help",  picture: "fa fa-expand", color:"tile blue w2 h1 icon-featurecw titlex-fadeout isotope-item" },
